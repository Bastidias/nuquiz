...
**Domain:** 1 — Security and Risk Management &nbsp;|&nbsp; **Predicate style:** Dimensions &nbsp;|&nbsp; **Tags:** 1.2
...
| Subject | definition | common threats | common controls | example violation |
|---|---|---|---|---|
...
| Availability | Ensuring authorized users have timely and reliable access to information and resources | Denial of Service (DoS)<br>Distributed Denial of Service (DDoS)<br>Hardware failure<br>Natural disaster<br>Ransomware | Redundancy and failover<br>Load balancing<br>Backups and restoration testing<br>Disaster recovery planning<br>Capacity planning | Ransomware encrypts critical systems making them inaccessible during business hours |

## Notes

- **Cell convention:** each `<br>`-separated item within a cell is one atomic triple at import time. Empty cells = no fact authored yet for that (Subject, Predicate) pair.
